...
import com.lmh.enums.OperatorFriendRequestTypeEnum;
import com.lmh.enums.SearchFriendsStatusEnum;
import com.lmh.pojo.Users;
import com.lmh.pojo.bo.UsersBO;
import com.lmh.pojo.vo.MyFriendsVO;
import com.lmh.service.UserService;
import com.lmh.pojo.vo.UsersVO;
import com.lmh.utils.FastDFSClient;
import com.lmh.utils.FileUtils;
import com.lmh.utils.MD5Utils;
import com.lmh.utils.TigerChatJSONResult;
...
public class UserController {
    ...
    public TigerChatJSONResult registOrLogin(@RequestBody Users user) throws Exception {

        // 0. 判断用户名和密码不能为空
        if (StringUtils.isBlank(user.getUsername())
                || StringUtils.isBlank(user.getPassword())) {
            return TigerChatJSONResult.errorMsg("用户名或密码不能为空...");
        }
        ...
        if (usernameIsExist) {
            ...
            if (userResult == null) {
                return TigerChatJSONResult.errorMsg("用户名或密码不正确...");
            }
        } else {
            // 1.2 注册
    ...
    public TigerChatJSONResult uploadFaceBase64(@RequestBody UsersBO userBO) throws Exception {
...
//		"dhawuidhwaiuh3u89u98432_80x80.png"
        ...
        return TigerChatJSONResult.ok(result);
    }
    ...
    public TigerChatJSONResult setNickname(@RequestBody UsersBO userBO) throws Exception {
    ...
    public TigerChatJSONResult addFriendRequest(String myUserId, String friendUsername)
            throws Exception {
    ...
    public TigerChatJSONResult getUnReadMsgList(String acceptUserId) {
        ...
        // 查询列表
        List<com.lmh.pojo.ChatMsg> unreadMsgList = userService.getUnReadMsgList(acceptUserId);
